...
void set_user_functions() {
    ...
    user_cpp_functions = {"Linear", "tensor_view", "tensor_clip", "tensor_argmax", "tensor_tmax", "tensor_onehot", "tensor_shape", "tensor_permute", "tensor_cpu", "printtt",
		...
		"join_gc", "sweep", "psweep", "scope_struct_Join_GC", "scope_struct_Alloc_GC", "GC_print", 
		...
		"nullptr_get", "is_null", 
		"array_Create", "array_size", "array_bad_idx", "array_double_size", "array_clear", "array_int_NewVec", "array_print_int", "arange_int", "zeros_int", "randint_array", "ones_int", "array_int_add", "randfloat_array", "array_print_float", "arange_float", "zeros_float", "ones_float", "array_Split_Parallel", "array_print_str", 
		...
		"str_Copy", "str_eq", "str_int_add", "str_float_add", "int_str_add", "float_str_add", "str_bool_add", "bool_str_add", "PrintStr", "cat_str_float", "str_split_idx", "can_convert_to_float", "str_to_float", "str_str_different", "str_str_equal", "str_Delete", "readline", 
		...
		"map_Create", "map_expand", "map_has_str", "print_str", "map_print", "map_keys", "map_values", "map_bad_key_str", "map_bad_key_int", "map_bad_key_float", 
		...
		"Delete_Ptr", 
		"GC_array_append_barrier", "GC_write_barrier_obj", 
