...
void set_user_functions() {
    ...
    user_cpp_functions = {"Linear", "tensor_view", "tensor_clip", "tensor_argmax", "tensor_tmax", "tensor_onehot", "tensor_shape", "tensor_permute", "tensor_cpu", "printtt",
		...
		"nullptr_get", "is_null", 
		"array_Create", "array_size", "array_bad_idx", "array_double_size", "array_clear", "array_int_NewVec", "array_void_NewVec", "array_print_int", "arange_int", "zeros_int", "randint_array", "ones_int", "array_int_add", "randfloat_array", "array_print_float", "arange_float", "zeros_float", "ones_float", "array_Split_Parallel", "array_print_str", "array_shuffle_str", 
